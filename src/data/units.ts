...
export const units: Unit[] = [
  {
    ...
    description:
      "Relax and unwind in this serene mountain-view B&B apartment, nestled into a forested hillside with stunning views of Tumwater Mountain, Icicle Ridge, and Wedge Mountain. This cozy space features a kitchenette with basics to cook simple meals, and a private deck to take in the scenery. Simple in-apartment breakfast is provided. Just a 20-minute walk to downtown Leavenworth.",
    amenities: [
      "Queen Bed",
      "Kitchenette",
      "Private Deck",
  ...
  },
  {
    id: "onebr",
    name: "The Apartment",
    tagline: "Spacious apartment with room for the whole family",
    description:
      "A thoughtfully designed B&B apartment featuring a spacious living area with large windows, a cozy bedroom with work station, and full bathroom. A comfy air mattress and pack-n-play are available for extra guests. Simple in-apartment breakfast foods are provided, along with a Nespresso coffee station, fridge, toaster, and microwave. Samsung Frame smart TV with streaming apps. Private entrance and deck with views over orchards down the Wenatchee valley.",
    amenities: [
      "Queen Bed",
